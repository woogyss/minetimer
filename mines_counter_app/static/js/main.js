            ...
            $("#mines").append(`
                <div class="mine">
                    ...
                    <div class="dial-container">
                        ...
                        <div class="max-time-display" id="max_${index}">${formatTime(mine.maximum)}</div>
                    </div>
                    <div class="inputs-container">
                        <input type="number" id="input_${index}" placeholder="Тек. значение" min="0" max="${mine.maximum}">
                    ...
                    <div class="buttons-container">
                        ...
                        <button onclick="updateMaxValue(${index})">Обновить</button>
                    </div>
                </div>
            `);
        });
    ...
    setInterval(() => {
        $.getJSON("/get_mine_data", function(data) {
            data.forEach((mine, index) => {
                ...
                $(`#max_${index}`).text(`${formatTime(mine.maximum)}`);
            });
        });
    }, 1000);
});
